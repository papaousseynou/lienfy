export default function FifthSection() {
  return (
    <div className="bg-gray-100 h-fifth-height w-auto">
      <br />
      <h1 className="text-center text-4xl font-bold mx-8 font-sans">FAQ</h1>

      <div className=" bg-white flex flex-col shadow-md rounded h-40 mx-16 my-12 justify-center items-center border border-gray-400">
        ...
        <p className="text-xl text-center font-medium text-gray-400 mt-2">
          <b className="text-orange-500">.R :</b> Les liens raccourcis sont plus
          esthétiques et prennent moins de place. Ils sont <br /> souvent
      ...
      <div className=" bg-white flex flex-col shadow-md rounded h-40 mx-16 my-12 justify-center items-center border border-gray-400">
        ...
        <p className="text-xl text-center font-medium text-gray-400 mt-2">
          <b className="text-orange-500">.R :</b> Amélioration de
      ...
      <div className=" bg-white flex flex-col shadow-md rounded h-40 mx-16 my-12 justify-center items-center border border-gray-400">
        ...
        <p className="text-xl text-center font-medium text-gray-400 mt-2">
          <b className="text-orange-500">.R :</b>En général, oui. Cependant,
          soyez conscient que les liens raccourcis peuvent <br />
